      ...
      <header id="top" className="w-screen flex flex-row bg-zoning shadow-xl flex-none">
        <Link to="/" className="flex flex-row grow-0 p-4">
          ...
          <div className="grow-0 py-4 px-2">
            <h1 className="stroke-title font-grands pt-2">
              Pet&nbsp;Foster
              <br />
              Connect
              <br />
        ...
        <div
          onClick={closeMenu}
          className="grow-1 flex flex-col md:flex-row flex-auto max-[767px]:nav-links"
          id="nav-links"
        >
          ...
          <nav className="flex flex-auto grow-1  place-self-center md:place-self-end pb-4 pr-8 text-m md:text-base xl:text-xl text-center lg:text-left">
            <ul className="flex flex-auto flex-col md:flex-row md:place-content-end md:gap-5 pl-4 gap-2">
              <li className="hover:text-accents1-light place-self-start item-link">
                <NavLink end tabIndex={0} to="/animaux" className={isCurrentPage}>
                  Nos Animaux
                </NavLink>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <NavLink end tabIndex={0} to="/associations" className={isCurrentPage}>
                  Nos Partenaires
                </NavLink>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <NavLink end tabIndex={0} to="/a-propos" className={isCurrentPage}>
                  Qui sommes&#x2011;nous&nbsp;?
                </NavLink>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <NavLink end tabIndex={0} to="/faq" className={isCurrentPage}>
                  Foire aux Questions
                </NavLink>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <NavLink end tabIndex={0} to="/devenir-famille-d-accueil" className={isCurrentPage}>
