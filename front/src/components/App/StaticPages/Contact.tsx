    ...
    <main className="justify-self-stretch flex-1">
      ...
      <section className="font-body text-center text-texte">
        ...
        <article className="bg-zoning font-body mx-auto w-[60%] rounded-lg shadow dark:bg-gray-800 my-2 py-5">
          <img
            ...
            alt="Une jolie photo des locaux"
          />
      ...
      <section>
        <div className="font-body mx-auto w-[60%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-2">
          ...
          <form
            className="flex flex-col flex-wrap justify-around text-texte"
            onSubmit={() => (window.location.href = 'mailto:laura.martin-wortham@oclock.school')}
          >
            <div className="mx-auto w-[60%] p-2">
              <label className="text-center" htmlFor="prenom">
                Votre Prénom
              </label>
              <input
            ...
            <div className="mx-auto w-[60%] p-2">
              <label className="text-center" htmlFor="msg">
                Votre Message
              </label>
              <textarea
                className="block bg-fond w-full"
                ...
                rows={5}
                cols={30}
                placeholder="J'aime beaucoup les tortues, merci de penser à elles !"
                required
              />
            </div>
            <button
