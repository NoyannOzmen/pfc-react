...
function FosterProfile() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const { prenom, nom, email, hebergement, terrain, rue, commune, code_postal } =
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/famille/profil`, {
        method: 'POST',
        headers: {
  ...
  async function handleDelete(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/famille/profil/delete`, {
        method: 'POST',
        headers: {
          'Content-type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  return (
    <main className="justify-self-stretch flex-1">
      <h2 className="font-grands text-3xl text-center my-2 py-6">
      ...
      <div className="flex flex-col content-center justify-center mx-auto mb-4 w-[80%]">
        <nav className="flex flex-wrap justify-center md:justify-start">
          <ul className="flex flex-wrap-reverse gap-x-2 mx-3 justify-center font-semibold md:justify-start md:ml-10 text-xl">
            <li>
              <Link to="/famille/profil" tabIndex={0}>
                <button id="dashbtn-1" className="dashbtn dashbtn-active" tabIndex={-1}>
                  Mon profil
                </button>
              </Link>
            </li>
            <li>
              <Link to="/famille/profil/demandes" tabIndex={0}>
                <button id="dashbtn-2" className="dashbtn" tabIndex={-1}>
                  Demandes
                </button>
              </Link>
            </li>
        ...
        <div className="font-body bg-zoning rounded-lg shadow dark:bg-gray-800 mb-4">
          <section className="flex flex-wrap justify-center" id="dashboard-container">
            ...
            <form
              className="flex flex-col flex-wrap content-center justify-around text-texte w-full"
              onSubmit={handleSubmit}
            >
              <fieldset className="w-[60%] font-body rounded-lg shadow dark:bg-gray-800 my-2 py-5">
                <legend className="text-center">
                  Mes informations&nbsp;
                  <span tabIndex={0} className="material-symbols-outlined" onClick={allowEdit}>
                    edit
                  </span>
                </legend>

                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="prenom">
                    Prénom
                  </label>
                  <input
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="nom">
                    Nom
                  </label>
                  <input
                    className="block w-full"
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="email">
                    Email
                  </label>
                  <input
                    className="block w-full"
              ...
              <fieldset className="font-body rounded-lg shadow dark:bg-gray-800 my-2 py-5">
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="hebergement">
                    Type
                  </label>
                  <input
                    className="block w-full"
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="terrain">
                    Terrain
                  </label>
                  <input
                    className="block w-full"
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="rue">
                    Rue
                  </label>
                  <input
                    className="block w-full"
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="commune">
                    Commune
                  </label>
                  <input
                    className="block w-full"
                ...
                <div className="mx-auto p-2">
                  <label className="text-center w-full" htmlFor="code_postal">
                    Code Postal
                  </label>
                  <input
                    className="block w-full"
              ...
              <button
                id="validate"
                className="hidden w-[60%] mx-auto my-3 py-2 px-4 bg-accents1-light text-fond transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                type="submit"
              >
            ...
            <div className="flex flex-col flex-wrap content-center justify-around text-texte">
              <button
                ...
                id="deleteAccount"
                className="w-[60%] mx-auto my-3 py-2 px-4 bg-accents2-dark text-fond transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                type="submit"
              >
      ...
      <div
        ...
        className="hidden justify-center content-center fixed bg-texte/20 inset-0"
      >
        <div className="self-center bg-zoning p-6 rounded-lg">
          <div className="flex justify-between">
            ...
            <span
              onClick={displayModal}
              className="cancel material-symbols-outlined text-texte cursor-pointer"
            >
              close
            </span>
          </div>
          <form id="delete-container" className="" onSubmit={handleDelete}>
            <div className="mb-2">
              <p className="block text-texte font-grands font-bold text-base">
            ...
            <div>
              <input
                className="cursor-pointer hover:bg-accents1-dark rounded-full hover:underline bg-accents1 text-center font-grands text-fond font-semibold text-base py-1 px-4"
                type="submit"
                value="Valider"
              />
              <button
                onClick={displayModal}
                className="hover:bg-accents2-dark rounded-full hover:underline bg-accents2-dark text-center font-grands text-fond font-semibold text-base py-1 px-4 cancel"
              >
                Annuler
              </button>
            </div>
