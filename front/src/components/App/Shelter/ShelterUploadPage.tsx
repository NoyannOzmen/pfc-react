...
function ShelterUploadPage() {
  ...
  const [currentLogo, setCurrentLogo] = useState(shelter?.images_association[0]);
            ...
            <form className="self-center" onSubmit={sendFile}>
              ...
              <div className="flex justify-center">
                <input
                  type="submit"
                  value="Importer"
                  className="my-3 py-2 px-4 mx-auto bg-accents2-dark text-fond transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                />
              </div>
            </form>
          </section>
          ...
          {currentLogo && (
            <div className="flex flex-col justify-center">
              ...
              <img
                ...
                src={`${import.meta.env.VITE_API_URL}` + `${currentLogo.url}`}
                alt=""
              />
            </div>
          )}
