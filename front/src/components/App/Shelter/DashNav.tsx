  ...
  return (
    <nav className="flex flex-wrap justify-center md:justify-start">
      <ul className="flex flex-wrap-reverse gap-x-2 mx-3 justify-center font-semibold md:justify-start md:ml-10 text-xl">
        ...
        <li><NavLink to="/associations/profil/demandes" end tabIndex={0} className={isActiveTab}>Demandes</NavLink></li>
        <li><NavLink to="/associations/profil/animaux" end tabIndex={0} className={isActiveTab}>Animaux</NavLink></li>
      </ul>
