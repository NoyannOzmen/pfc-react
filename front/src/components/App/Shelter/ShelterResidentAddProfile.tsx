  ...
  <div className="flex flex-col content-center justify-center mx-auto mb-4 w-[80%]">
    ...
    <div className="flex flex-col bg-zoning rounded-lg">
      ...
      <section className="flex flex-col justify-center content-center">
        ...
        <form className="grid grid-cols-1 my-6 mx-6 justify-center lg:flex-none lg:mx-2 lg:grid lg:grid-cols-3 lg:px-2 xl:grid-cols-3 xl:p-10" action="/animaux/nouveau-profil" method="post">
          ...
          <fieldset className="flex flex-wrap justify-center gap-x-4">
            ...
            <div className="mb-2 w-full">
              ...
              <fieldset name="tags-animal" id="tags-animal" className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full px-2 py-1">
               ...
               {/*  <% tags.forEach(tag => { %>
                  <div className="flex gap-x-1.5 w-full"> 
                    <input type="checkbox" id="tag_<%= tag.id %>" name="tag_<%= tag.id %>" value="<%= tag.id %>" className="leading-3 size-6"/>
                    <label htmlFor="tag_<%= tag.id %>" className="block font-grands text-xs leading-3"><%= tag.nom %></label>
                  </div>
                <% }) %> */}
              ...
              <div className="flex justify-center">
                <button id="create-tag" className="self-center hover:bg-accents1-dark rounded-full hover:underline bg-accents1 text-center font-grands text-fond font-semibold text-base py-0.5 px-4">Créer un tag</button>
              </div>
            </div>
...
<div id="create-tags-modal" className="hidden flex justify-center content-center fixed bg-texte/20 inset-0">
  ...
  <div className="self-center bg-zoning p-6 rounded-lg">
    ...
    <form id="create-tags-form" className="" method="post" action="/tags/create">
