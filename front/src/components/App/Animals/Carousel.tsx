...
function Carousel() {
      ...
      <div className="flex bg-fond rounded-lg shadow dark:bg-gray-800 flex-col md:flex-col mx-auto my-2 w-[75%] p-4">
        <div className="w-full md:w-full flex justify-center items-center">
          {animal.images_animal ? (
            <img
              className="object-contain md:h-full rounded-lg"
  ...
  return (
    <section
      id="animal-carousel"
      className="md:flex md:flex-row relative mx-auto h-auto w-[90%] bg-zoning rounded-lg shadow dark:bg-gray-800"
    >
      <button
      ...
      >
        <img
          src="/icons/left.svg"
          alt=""
          onClick={width < 768 ? getOnePreviousPic : getThreePreviousPic}
        />
      </button>
      ...
      >
        <img
          src="/icons/right.svg"
          alt=""
          onClick={width < 768 ? getOneNextPic : getThreeNextPic}
        />
      </button>
    </section>
  );
