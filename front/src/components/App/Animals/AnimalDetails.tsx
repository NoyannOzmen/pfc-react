    ...
    <main className="flex flex-wrap flex-col md:flex-row justify-self-stretch flex-1 w-[90%] place-content-evenly 2xl:self-center">
      <section className="flex flex-col m-4 flex-1 max-[767px]:mx-4 md:ml-6 place-content-evenly">
        ...
        <div className="font-body mx-auto w-[80%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-4">
          {animalUrl ? (
            <img
              ...
              src={`${import.meta.env.VITE_API_URL}` + `${animalUrl}`}
        ...
        <article className="font-body mx-auto w-[80%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-4">
          <div className="text-center w-full py-2">
            <h3 className="font-grands text-3xl text-center my-2 w-full">
              A propos de {animal.nom}
            </h3>
          </div>

          <div className="text-center w-full flex justify-center gap-2 py-2">{tagItems}</div>
          ...
          <div className="text-center w-full py-2">
            ...
            {animal.race && <p className="font-body text-texte">Race : {animal.race}</p>}
          ...
          <div className="text-center w-full py-2">
            <p className="font-body text-texte">
          ...
          {auth.user?.accueillant && (
            <div className="text-center w-full py-2">
              ...
              <form onSubmit={handleSubmit}>
                <button
                  type="submit"
                  className="mx-auto my-3 py-2 px-6 bg-accents1-light text-fond transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                >
                  Faire une demande
                </button>
              </form>
      ...
      <section className="flex flex-col md:my-8 flex-none  md:max-w-[50%] max-[767px]:mx-4 md:mr-6 md:mt-32 py-6">
        <article className="font-body mx-auto w-full bg-zoning rounded-lg shadow dark:bg-gray-800 my-4">
          <h3 className="font-grands text-3xl text-center my-2 pt-5 w-full">
            {animal.nom}
            <br />
            vous attend chez
            <br />
          ...
          <div className="font-body mx-auto w-[80%] rounded-lg my-4">
            {shelterUrl ? (
              <img
                className="mx-auto"
                src={`${import.meta.env.VITE_API_URL}` + `${shelterUrl}`}
          ...
          <div className="text-center w-full py-2">
            ...
            {animal.refuge.site && (
              <p className="font-body text-texte">E-mail : {animal.refuge.site}</p>
            )}
            {animal.refuge.description && (
              <p className="font-body text-texte">{animal.refuge.description}</p>
            )}
          </div>
          ...
          <div className="text-center w-full py-2 my-4">
            <Link
              ...
              to={`/associations/${animal.refuge.id}`}
            >
              En savoir plus
            </Link>
          </div>
      ...
      <section className="p-4 py-6 block">
        <h2 className="font-grands text-3xl text-center my-2">
