  ...
  return (
    ...
    >
      <button
        ...
        tabIndex={0}
      >
        <img src="/icons/left.svg" alt="" onClick={getOnePreviousPic} />
      </button>

      <div className="h-auto mx-auto rounded-lg p-4">{animalItemsOne}</div>
      ...
      <button
        ...
        tabIndex={0}
      >
        <img src="/icons/right.svg" alt="" onClick={getOneNextPic} />
      </button>
    </section>
  );
}
